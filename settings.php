...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox(
        'consentform/confirmincourseoverview',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'consentform/nocoursemoduleslist',
