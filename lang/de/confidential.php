...
$string['confidential:addinstance'] = 'Einverständniserklärung hinzufügen';
$string['confidential:submit'] = 'Einverständniserklärung bearbeiten';
$string['confidential:view'] = 'Einverständniserklärung ansehen';
$string['confidentialname'] = 'Name';
$string['confidential'] = 'Einverständniserklärung';
...
$string['noavailability'] = 'Dieses Modul benötigt das Feature "Verfügbarkeit", welches in diesem Moodle nicht aktiviert ist. Wenden Sie sich an Ihren Moodle-Administrator.';
$string['nocompletion'] = 'Dieses Modul benötigt das Feature "Abschlussverfolgung", welches in diesem Moodle nicht aktiviert ist. Wenden Sie sich an Ihren Moodle-Administrator.';
...
$string['eventagreementagree'] = "Benutzer hat zugestimmt";
$string['eventagreementagreedesc'] = 'Der Benutzer mit der ID {$a->userid} hat der Einverständniserklärung des Moduls {$a->contextinstanceid} zugestimmt.';
$string['eventagreementdisagree'] = "Benutzer hat NICHT zugestimmt";
$string['eventagreementagreedesc'] = 'Der Benutzer mit der ID {$a->userid} hat der Einverständniserklärung des Moduls {$a->contextinstanceid} NICHT zugestimmt.';
$string['revocation'] = 'Widerrufen';
$string['optiondisagree'] = 'Widerrufsoption';
$string['optiondisagreedesc'] = 'Erlauben Sie Benutzern, Ihre Einverständniserklärung zurückzuziehen.';
