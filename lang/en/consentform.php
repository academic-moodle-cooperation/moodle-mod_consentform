...
$string['completionagree'] = 'Agree to the consent form';
$string['completionrequired'] = 'Completion must stay active. Select manual completion or add completion requirements.';
$string['completionresponded'] = 'Agree to or refuse the consent form';
...
$string['overviewagreed'] = 'Agreed';
$string['overviewmydecision'] = 'My decision';
$string['overviewnoaction'] = 'No action';
$string['overviewrefused'] = 'Refused';
$string['overviewrevoked'] = 'Revoked';
